<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/MasterPages/SolarPMS.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="SolarPMS.ChangePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="col-xs-12 padding-0 padding-b-2">
                ...
                <div class="col-xs-12 heading-big">
                    <h5 class="margin-0 lineheight-30 breath-ctrl">Home / <span style="font-weight: normal !important"> Change Password</span></h5>
                </div>
            </div>

    <div class="row margin-0">
        <div class="change-password padding-t-20">
            <div class="row margin-0" id="divContainer" runat="server">
                ...
                <div class="submit-btn">
                        <asp:Button ID="btnCancel" CausesValidation="false" runat="server" Text="Clear" CssClass="btn btn-primary button-style" OnClick="btnCancel_Click" />
                </div>
                </center>
                </div>
