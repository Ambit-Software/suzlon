<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SolarPMS.Master" AutoEventWireup="true" CodeBehind="TableActivitySCB.aspx.cs" Inherits="SolarPMS.Admin.TableActivitySCB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="drpSite">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="ddlSCBNo" LoadingPanelID="LoadingPanel1"></telerik:AjaxUpdatedControl>
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div class="row margin-0">
        <div class="col-xs-12 heading-big">
            <h5 class="margin-0 lineheight-30 breath-ctrl">Home / Administration / Table Activity / <span style="font-weight: normal !important">SCB</span></h5>
        </div>
    </div>
    <div class="row margin-0">
        ...
        <div class="survey-wrapper">
            <div class="row margin-0">
                ...
                <div class="col-xs-12">
                    <div class="col-xs-2 ">
                        <label class="col-xs-12 control-label lable-txt padding-0" for="name">SCB No.</label>
                    </div>
                    <div class=" col-xs-10 padding-0">
                        <telerik:RadComboBox runat="server" RenderMode="Lightweight" ID="ddlSCBNo" Skin="Office2010Silver"
                            EmptyMessage="Select SCB Number" Filter="Contains" MarkFirstMatch="true" Width="100%">
                        </telerik:RadComboBox>
                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator6" ControlToValidate="ddlSCBNo"
                            Display="Static" ErrorMessage="* Required!" ForeColor="Red" CssClass="validator" />
                    </div>
                </div>
                <div class="col-xs-12">
