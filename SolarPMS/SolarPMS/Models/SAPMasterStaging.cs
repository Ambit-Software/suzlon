...
namespace SolarPMS.Models
{
    ...
    public partial class SAPMasterStaging
    {
        ...
        public string ActivityPlanStartDate { get; set; }
        public string ActivityPlanFinishDate { get; set; }
        public Nullable<decimal> ActivityQty { get; set; }
        public string ActivityPlanQtyUoM { get; set; }
        public string ActivityActualStartDate { get; set; }
        public string ActivityActualFinishDate { get; set; }
        ...
        public virtual WBSArea WBSArea1 { get; set; }
    }
}
