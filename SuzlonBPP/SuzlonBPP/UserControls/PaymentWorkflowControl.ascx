<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentWorkflowControl.ascx.cs" Inherits="SuzlonBPP.UserControls.PaymentWorkflowControl" %>
                        ...
                        <div class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body overflow-x">
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Vertical Aggregator</th>
                                            <th class="text-center">Vertical Controller</th>
                                            <th class="text-center">Exceptional Approver</th>
                                            <th class="text-center">Auditor</th>
                                            <th class="text-center">F&A SSC-DT</th>
                                            <th class="text-center">F&A SSC-C&B</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                ...
                                <div class="col-xs-12 padding-0">
                                    <center>
                                        <asp:Label CssClass="btn btn-primary button button-style" ID="lblSave" runat="server" Text="Save" />
