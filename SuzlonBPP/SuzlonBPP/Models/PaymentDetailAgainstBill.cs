...
namespace SuzlonBPP.Models
{
    ...
    public partial class PaymentDetailAgainstBill
    {
        public int PaymentDetailAgainstBillId { get; set; }
        ...
        public virtual SAPAgainstBillPayment SAPAgainstBillPayment { get; set; }
